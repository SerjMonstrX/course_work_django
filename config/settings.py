...
SECRET_KEY = 'django-insecure-6=$@p=^7-fwjnvwe$%8$ih844fdcrjpfk0qgz9ad1v1(&z)#go'
...
CELERY_BEAT_SCHEDULE = {"start-mailing-task": {"task": "mailing.tasks.start_mailing", "schedule": crontab(minute="*/1"), }, }
